...
<table>
    ...
    <ul>
      ...
      <li><p>Logic Rules.  What are rules?  Rules are bits of code that can execute to make outbound calls, update records, or modify what was submitted.  Here's an example.  <a href="https://github.com/jacebenson/rw-poc/blob/main/api/src/rules/tickets/example-rule-loaded.js">Correct jace's name</a></p></li>
